...
const AlertStyled = styled.div`
    ...
    @media screen and (max-width: 600px){
        top: 20px; right: 20px; border-radius: 17.5px; width: 35px; height: 35px; 
    }
...
const MessageBox = styled.div`
    ...
    &::after{ 
        ...
        width: 0; height: 0;
	    border-top: 12px solid transparent; border-bottom: 12px solid transparent; border-left: 15px solid rgba(0,0,0,0.7);/* 화살표 */
    }
    @media screen and (max-width: 600px){
        top: -35px; right: 53px; width: 270px; font-size: 13px;
        &::after{ top: 40px; }
    }
`
